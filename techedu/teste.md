# tecnologias na educação · 2026.2
...
- **grupo oficial:** [link do whatsapp]
- **(opcional) videochamadas:** [link do meet]
- **(opcional) espaços digitais:** [link do excalidraw]

---

## visão

- **a base (ponto de partida):** ferramentas digitais são frequentemente introduzidas na educação como cosmético ou entretenimento passivo, sem atacar as dores reais da sala de aula.
- **o horizonte (onde queremos chegar):** capacitar os estudantes a construírem soluções tecnológicas autênticas, funcionais e embasadas contra o óbvio educacional.
