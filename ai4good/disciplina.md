...
| · 02 ·<br>14/08<br>· sex · | prática<br>**configuração base, harness, repositório e overleaf** | [`[3] artefato · git repo`](artefatos/3-base-git-repo.md)<br>[`[4] artefato · latex project`](artefatos/4-latex-project.md) |
| · 03 ·<br>19/08<br>· qua · | teoria<br>**história e princípios da aprendizagem supervisionada** | [`[1] slides · história`](https://lucassf.pages.dev/ai4good/historia)<br>[`[1] slides · regressão linear`](https://lucassf.pages.dev/ai4good/regressao-linear)<br>[`[1] slides · perceptron`](https://lucassf.pages.dev/ai4good/perceptron-multicamadas) |
...
| · 07 ·<br>02/09<br>· qua · | teoria<br>**arquiteturas de deep learning, decode, imagens e grafos** | [`[1] slides · autocodificadores`](https://lucassf.pages.dev/ai4good/autocodificadores)<br>[`[1] slides · redes convolucionais`](https://lucassf.pages.dev/ai4good/redes-convolucionais)<br>[`[1] slides · redes de grafos`](https://lucassf.pages.dev/ai4good/redes-de-grafos) |
| · 08 ·<br>04/09<br>· sex · | teoria<br>**arquiteturas de deep learning, temporalidade e linguagem** | [`[1] slides · redes recorrentes`](https://lucassf.pages.dev/ai4good/redes-recorrentes)<br>[`[1] slides · memória curta e longa`](https://lucassf.pages.dev/ai4good/memoria-longa-de-curto-prazo) |
...
| · 13 ·<br>23/09<br>· qua · | teoria<br>**superinteligência e singularidade, experimentos e casos reais** | [`[1] slides · agência`](https://lucassf.pages.dev/ai4good/agencia)<br>[`[1] slides · autoaprimoramento`](https://lucassf.pages.dev/ai4good/autoaprimoramento)<br>[`[0] slides · autopreservação`](https://lucassf.pages.dev/ai4good/autopreservacao) |
...
| · 15 ·<br>30/09<br>· qua · | teoria<br>**crises relacionadas e caminhos de transformação** | [`[1] slides · crises`](https://lucassf.pages.dev/ai4good/crises) |
